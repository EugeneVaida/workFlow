...
var routes = [
    ...
    { path: 'sprints', loadChildren: './sprints/sprints.module#SprintsPageModule' },
...
var CompanyService = /** @class */ (function () {
    function CompanyService(http, connectionService) {
        this.http = http;
        this.connectionService = connectionService;
        this.rootUrl = this.connectionService.rootUrl;
    }
    CompanyService.prototype.postCompany = function (cmp) {
        ...
        return this.http.post(this.rootUrl + '/api/CreateCompany', body, requestOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (x) { return x.json(); }));
    };
    CompanyService.prototype.putCompany = function (id, cmp) {
        var body = JSON.stringify(cmp);
        ...
        return this.http.put(this.rootUrl + '/api/UpdateCompany/' + id, body, requestOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res.json(); }));
    };
    CompanyService.prototype.getAllCompanies = function () {
        var _this = this;
        this.http.get(this.rootUrl + '/api/GetAllCompanies')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) {
            return data.json();
        })).toPromise().then(function (x) {
            _this.companiesList = x;
        });
    };
    CompanyService.prototype.deleteCompany = function (id) {
        ...
        return this.http.delete(this.rootUrl + '/api/DeleteCompany/' + id, requestOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res.json(); }));
    };
...
var ConnectionService = /** @class */ (function () {
    function ConnectionService() {
        ...
        this.rootUrl = 'https://work-flow-service.herokuapp.com';
    }
...
var ProjectService = /** @class */ (function () {
    ...
    ProjectService.prototype.getAllProjectsByTag = function (id) {
        var _this = this;
        this.http.get(this.rootUrl + '/api/GetProjectsByTag/' + id)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) {
            return data.json();
        })).toPromise().then(function (x) {
            _this.project = x;
    ...
    ProjectService.prototype.deleteProject = function (id) {
        ...
        //var header = new HttpHeaders({"Authorization" : "Bearer " + localStorage.getItem('userToken')});
        var requestOptions = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["RequestOptions"]({ method: _angular_http__WEBPACK_IMPORTED_MODULE_2__["RequestMethod"].Delete, headers: headerOptions });
        return this.http.delete(this.rootUrl + '/api/DeleteProject/' + id, requestOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res.json(); }));
    };
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/http */ "./node_modules/@angular/http/fesm5/http.js");
/* harmony import */ var _connection_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./connection.service */ "./src/app/shared/connection.service.ts");
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.registerUser = function (user, roles) {
        ...
        console.log(body);
        var reqHeader = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["Headers"]({ 'Content-Type': 'application/json', 'No-Auth': 'True' });
        return this.http.post(this.rootUrl + '/api/User/Register', body, { headers: reqHeader }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) { return res.json(); }));
    };
    UserService.prototype.userAuthentication = function (userName, password) {
        var data = "username=" + userName + "&password=" + password + "&grant_type=password";
        var reqHeader = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["Headers"]({ 'Content-Type': 'application/x-www-form-urlencoded', 'No-Auth': 'True' });
        return this.http.post(this.rootUrl + '/token', data, { headers: reqHeader }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) { return res.json(); }));
    };
    UserService.prototype.getUserClaims = function () {
        return this.http.get(this.rootUrl + '/api/GetUserClaims').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) { return res.json(); }));
    };
    UserService.prototype.getAllRoles = function () {
        var reqHeader = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["Headers"]({ 'No-Auth': 'True' });
        return this.http.get(this.rootUrl + '/api/GetAllRoles', { headers: reqHeader }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) { return res.json(); }));
    };
    ...
    UserService.prototype.postUser = function (user) {
        ...
        headerOptions.append('Authorization', "Bearer " + localStorage.getItem('userToken'));
        var requestOptions = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["RequestOptions"]({ method: _angular_http__WEBPACK_IMPORTED_MODULE_2__["RequestMethod"].Post, headers: headerOptions });
        return this.http.post(this.rootUrl + '/api/CreateUser', body, requestOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) { return res.json(); }));
    };
    UserService.prototype.putUser = function (id, user) {
        var body = JSON.stringify(user);
        var headerOptions = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["Headers"]({ 'Content-Type': 'application/json', "Authorization": "Bearer " + localStorage.getItem('userToken') });
        var requestOptions = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["RequestOptions"]({ method: _angular_http__WEBPACK_IMPORTED_MODULE_2__["RequestMethod"].Put, headers: headerOptions });
        return this.http.put(this.rootUrl + '/api/UpdateUser/' + id, body, requestOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) { return res.json(); }));
    };
    UserService.prototype.getAllUsers = function () {
        var _this = this;
        this.http.get(this.rootUrl + '/api/GetAllUsers')
    ...
    UserService.prototype.getRoles = function () {
        var _this = this;
        this.http.get(this.rootUrl + '/api/GetAllRoles')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (data) {
            return data.json();
        })).toPromise().then(function (x) {
            _this.rolesList = x;
    ...
    UserService.prototype.deleteUser = function (id) {
        ...
        //var header = new HttpHeaders({"Authorization" : "Bearer " + localStorage.getItem('userToken')});
        var requestOptions = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["RequestOptions"]({ method: _angular_http__WEBPACK_IMPORTED_MODULE_2__["RequestMethod"].Delete, headers: headerOptions });
        return this.http.delete(this.rootUrl + '/api/DeleteUser/' + id, requestOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) { return res.json(); }));
    };
